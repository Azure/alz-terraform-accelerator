locals {
  ...
  virtual_wan_settings_json_templated = templatestring(local.virtual_wan_settings_json, local.template_replacements)
  ...
  virtual_wan_virtual_hubs_json_templated = templatestring(local.virtual_wan_virtual_hubs_json, local.template_replacements)
