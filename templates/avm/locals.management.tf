locals {
  ...
  management_resource_settings_json_templated = templatestring(local.management_resource_settings_json, local.template_replacements)
...
locals {
  ...
  management_group_settings_json_templated = templatestring(local.management_group_settings_json, local.template_replacements)
