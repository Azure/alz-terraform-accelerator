locals {
  ...
  virtual_wan_name                          = templatestring(var.virtual_wan_name, { location = var.location })
  ...
  management_asc_export_resource_group_name = templatestring(var.management_asc_export_resource_group_name, { location = var.location })
}