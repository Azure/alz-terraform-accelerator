...
variable "management_asc_export_resource_group_name" {
  type        = string
  description = "The name of the resource group for the management ASC export resources"
  default     = "rg-management-asc-export-$${location}"
