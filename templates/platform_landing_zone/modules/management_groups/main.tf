module "management_groups" {
  ...
  subscription_placement_destroy_move_to_parent_resource_id_enabled = var.management_group_settings.subscription_placement_destroy_move_to_parent_resource_id_enabled
  subscription_placement_destroy_target_management_group_id         = var.management_group_settings.subscription_placement_destroy_target_management_group_id
}
