...
*/
locals {
  automation_account_name           = "${var.default_prefix}-automation-account-${var.location}${var.default_postfix}"
  log_analytics_workspace_name      = "${var.default_prefix}-log-analytics-${var.location}${var.default_postfix}"
  log_analytics_resource_group_name = "${var.default_prefix}-rg-logging-${var.location}${var.default_postfix}"
  hub_rg_name                       = "${var.default_prefix}-rg-hub-network-${var.location}${var.default_postfix}"
  firewall_policy_name              = "${var.default_prefix}-azfwpolicy-${var.location}"
  hub_vnet_name                     = "${var.default_prefix}-hub-${var.location}${var.default_postfix}"
  route_table_name                  = "${var.default_prefix}-rt-${var.location}${var.default_postfix}"
  nsg_name                          = "${var.default_prefix}-nsg-AzureBastionSubnet-${var.location}${var.default_postfix}"
  ...
  azure_bastion_public_ip_name      = "${var.default_prefix}-bas-${var.location}${var.default_postfix}-PublicIP${var.default_postfix}"
  azure_bastion_name                = "${var.default_prefix}-bas-${var.location}${var.default_postfix}"
