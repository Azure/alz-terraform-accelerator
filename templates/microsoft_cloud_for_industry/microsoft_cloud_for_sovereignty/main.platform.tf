...
/*
SUMMARY : Deploys platform for the Sovereign Landing Zone
...
module "hubnetworks" {
  ...
  hub_virtual_networks = {
    hub = {
      ...
      routing_address_space           = local.routing_address_space
...
resource "azurerm_virtual_network_gateway" "vnet_gateway" {
  ...
  ip_configuration {
    ...
    public_ip_address_id = (each.value.name != "noconfigVpn" && each.value != "noconfigEr") ? module.gateway_public_ip[each.key].public_ip_id : "na"
  }
