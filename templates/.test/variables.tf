...
variable "test_variable_02" {
  type = number
  description = "This is the second test variable|number"
}

variable "test_variable_03" {
  type = bool
  description = "This is the third test variable|bool"
}
...
variable "test_variable_05" {
  type = string
  description = "This is the fifth test variable|guid"
}

variable "test_variable_06" {
  type = string
  description = "This is the sixth test variable.|azure_name"
  default = "testing-123"
}