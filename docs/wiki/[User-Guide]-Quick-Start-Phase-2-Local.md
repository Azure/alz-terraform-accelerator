...
1. In your PowerShell Core (pwsh) terminal type `New-ALZEnvironment -IaC "terraform" -Cicd "local"`.
...
1. Fill out the following inputs:
    ...
    1. `target_directory`: This is the directory where the ALZ module code will be created. This defaults a directory called `alz` in the current working directory.
