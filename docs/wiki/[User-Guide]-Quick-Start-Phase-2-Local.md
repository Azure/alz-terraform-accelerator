...
1. Fill out the following inputs:
    ...
    1. `create_seed_resources_in_azure`: This determines whether the bootstrap will create the seed resources in Azure (e.g storage accoutn for state, identities, etc). This defaults to `true`.
