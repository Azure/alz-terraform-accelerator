...
locals {
  pipelines = {
    (local.ci_key) = {
      pipeline_name = local.resource_names.ci_pipeline_name
      file_path     = var.ci_file_path
      environment_keys = [
        local.plan_key
      ]
    ...
    (local.cd_key) = {
      pipeline_name = local.resource_names.cd_pipeline_name
      file_path     = var.cd_file_path
      environment_keys = [
        local.plan_key,
        local.apply_key
      ]
